<x-admin_layout>
    <div class="flex-1 p-10">
        <h2 class="text-2xl font-semibold mb-5">Add Phrase</h2>
        @if ($errors->any())
    ...
    @endif
        <form class="mb-8" method="POST" action="{{ route('admin.phrases.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text" id="author_name" name="author_name" placeholder="Enter Author Name"
                    class="appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('author_name') }}">
            </div>
            <div class="mb-4">
